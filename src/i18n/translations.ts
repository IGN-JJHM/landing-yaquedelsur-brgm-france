...
export const translations = {
  es: {
    ...
    footer: {
      ...
      aboutUrl: 'https://www.ign.go.do',
      contactTitle: 'Contáctanos',
      visitTitle: 'Búscanos',
      visitAddress:
        'C/ Jonas Salk #101, esq. Benigno Filomeno de Rojas, Zona Universitaria, Santo Domingo, R.D.',
      informTitle: 'Infórmate',
      phone: '809-221-8836',
      email: 'info@ign.gob.do',
  ...
  fr: {
    ...
    footer: {
      aboutTitle: 'À propos',
      aboutText:
        'Institut géographique national « José Joaquín Hungría Morell » (IGN-JJHM)',
      aboutUrl: 'https://www.ign.go.do',
      contactTitle: 'Contactez-nous',
      visitTitle: 'Nous trouver',
      visitAddress:
        'C/ Jonas Salk #101, esq. Benigno Filomeno de Rojas, zone universitaire, Saint-Domingue, R.D.',
      informTitle: 'Pour en savoir plus',
      phone: '809-221-8836',
      email: 'info@ign.gob.do',
  ...
  en: {
    ...
    footer: {
      aboutTitle: 'About us',
      aboutText:
        'National Geographic Institute “José Joaquín Hungría Morell” (IGN-JJHM)',
      aboutUrl: 'https://www.ign.go.do',
      contactTitle: 'Contact us',
      visitTitle: 'Find us',
      visitAddress:
        'C/ Jonas Salk #101, corner Benigno Filomeno de Rojas, University Zone, Santo Domingo, Dominican Republic',
      informTitle: 'Learn more',
      phone: '809-221-8836',
      email: 'info@ign.gob.do',
      faq: 'FAQ',
